...
(function() {
    ...
    var FirefoxWindowsPS2Controller = function(raw, into, index) {
        // Wow, dinput is a disaster.
        into.leftStickX = raw.axes[0];
        into.leftStickY = raw.axes[1];
        into.rightStickX = raw.axes[5];
        into.rightStickY = raw.axes[2];
        into.faceButton0 = raw.buttons[2];
        into.faceButton1 = raw.buttons[1];
        into.faceButton2 = raw.buttons[3];
        into.faceButton3 = raw.buttons[0];
        into.leftShoulder0 = raw.buttons[6];
        into.rightShoulder0 = raw.buttons[7];
        into.leftShoulder1 = raw.buttons[4];
        into.rightShoulder1 = raw.buttons[5];
        into.select = raw.buttons[8];
        into.start = raw.buttons[9];
        //into.leftStickButton = raw.buttons[8];
        //into.rightStickButton = raw.buttons[9];
...
// @IMAGEDATAURLS@
    ...
    if (isChrome && isWindows) {
        ...
        active.push([ '810-', '1-', FirefoxWindowsPS2Controller, "Playstation 2", Gamepad_ImageDataUrls_PS2 ]);
